...
def get_fc1(last_conv, num_classes, fc_type):
  ...
  if fc_type=='Z':
    ...
    filters_in = 512 # 512 for mobilefacenet
    # _weight = mx.symbol.Variable("fc1_weight", shape=(num_classes, filters_in), lr_mult=1.0, wd_mult=10.0)
    # conv_6_f = mx.sym.FullyConnected(data=conv_6_dw, weight = _weight, num_hidden=num_classes, name='pre_fc1')
    conv_6_dw = Linear(last_conv, num_filter=filters_in, num_group=filters_in, kernel=(4,4), pad=(0, 0), stride=(1, 1), name="conv_6dw7_7")
